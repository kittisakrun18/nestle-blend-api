...
public class ExcelHelper {
    ...
    public XSSFCellStyle generateCellStyleHeader(XSSFWorkbook workbook, Row row){
    ...
    public XSSFCellStyle generateCellStyleHeaderGr(XSSFWorkbook workbook, Row row){
        XSSFCellStyle style = workbook.createCellStyle();
        XSSFFont font = workbook.createFont();
    ...
    public XSSFCellStyle generateCellStyleContentSummary(XSSFWorkbook workbook){
        XSSFCellStyle style = workbook.createCellStyle();
        XSSFFont font = workbook.createFont();
        font.setFontName(this.fontName);
        font.setFontHeight(14);
    ...
    public XSSFCellStyle generateCellStyleContent(XSSFWorkbook workbook){
        XSSFCellStyle style = workbook.createCellStyle();
        XSSFFont font = workbook.createFont();
        font.setFontName(this.fontName);
        font.setFontHeight(14);
    ...
    public XSSFCellStyle generateCellStyleContent(XSSFWorkbook workbook,int fontSize, boolean bold){
        XSSFCellStyle style = workbook.createCellStyle();
        XSSFFont font = workbook.createFont();
        font.setFontName(this.fontName);
    ...
    public XSSFCellStyle generateCellStyleBgRed(XSSFWorkbook workbook) {
    ...
    public void createCell(XSSFSheet sheet, Row row, int columnCount, Object value, XSSFCellStyle style) {
    ...
    public void setBorderRangeAddress(int colorIndex, CellRangeAddress rangeAddress, XSSFSheet sheet){
